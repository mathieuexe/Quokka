...
export async function postAdminPromoCode(req, res) {
    ...
    const discountValue = payload.type === "fixed"
...
export async function patchAdminPromoCodeActive(req, res) {
...
export async function promoteServer(req, res) {
    ...
    await createGiftedStripePayment({
        ...
        durationHours: payload.type === "quokka_plus"
...
export async function hideServer(req, res) {
...
export async function makeServerVisible(req, res) {
    const payload = serverStateSchema.parse(req.body);
